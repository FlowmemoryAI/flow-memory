...
assert.match(html, /Loose signals/);
assert.match(html, /Neural braid/);
assert.match(html, /Memory weave/);
assert.match(html, /A neural strand story/);
assert.match(html, /Neural strands become memory/);
assert.match(html, /Work becomes signal/);
assert.match(html, /Strands combine/);
assert.match(html, /Memory takes shape/);
assert.match(html, /Neural strands combine/);
assert.match(html, /data-story-mode="swarm"/);
assert.match(html, /mission-3d-story-readout/);
assert.match(html, /mission-story-steps/);
assert.match(html, /data-neural-strands="true"/);
