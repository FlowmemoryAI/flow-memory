...
assert.match(html, /Contact mesh/);
assert.match(html, /Manim path/);
assert.match(html, /A visual proof story/);
assert.match(html, /Watch work become memory/);
assert.match(html, /Human work enters/);
assert.match(html, /Proof resolves/);
assert.match(html, /Memory persists/);
