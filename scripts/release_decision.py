...
def main() -> int:
    ...
    parser.add_argument("--target", choices=("local", "local-public-alpha", "public-alpha-local-launch", "public-alpha-launch-finalizer", "public-alpha", "testnet", "testnet-dry-run", "neural-gpu-smoke", "public-alpha-neural", "public-alpha-launch", "production"), default="local")
