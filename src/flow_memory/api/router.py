...
from flow_memory.api.agent_builder_endpoints import (
    agent_builder_assembly_plan,
    agent_builder_birth,
    agent_builder_defaults_endpoint,
    agent_builder_simulate_upgrades,
)
...
class LocalApiRouter:
    ...
    def _agent_builder_defaults(self, _params: Mapping[str, str], _payload: Mapping[str, Any]) -> Mapping[str, Any]:
        return agent_builder_defaults_endpoint()

    def _agent_builder_assembly_plan(self, _params: Mapping[str, str], payload: Mapping[str, Any]) -> Mapping[str, Any]:
        return agent_builder_assembly_plan(payload)

    def _agent_builder_birth(self, _params: Mapping[str, str], payload: Mapping[str, Any]) -> Mapping[str, Any]:
        return agent_builder_birth(payload)

    def _agent_builder_simulate_upgrades(self, _params: Mapping[str, str], payload: Mapping[str, Any]) -> Mapping[str, Any]:
        return agent_builder_simulate_upgrades(payload)
...
def create_default_router() -> LocalApiRouter:
    ...
    router.register("GET", "/agent-builder/defaults", router._agent_builder_defaults, "agent_builder_defaults")
    router.register("POST", "/agent-builder/assembly-plan", router._agent_builder_assembly_plan, "agent_builder_assembly_plan")
    router.register("POST", "/agent-builder/birth", router._agent_builder_birth, "agent_builder_birth")
    router.register("POST", "/agent-builder/simulate-upgrades", router._agent_builder_simulate_upgrades, "agent_builder_simulate_upgrades")
