...
_METRIC_NAMES: tuple[str, ...] = (
    ...
    "audit_export_verify_fail_total",
...
DEFAULT_ALERT_RULES: tuple[AlertRule, ...] = (
    ...
    AlertRule("billing-payout-adjustment-failed", "billing_payout_adjustment_failed_total", 1.0, ">=", "critical", "Refund or SLA credit payout adjustment failed and needs reconciliation."),
