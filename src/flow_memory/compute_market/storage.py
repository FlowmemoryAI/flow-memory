...
COMPUTE_RECORD_TYPES: tuple[str, ...] = (
    ...
    "capacity_quote",
    "capacity_forward_curve",
    "forward_capacity_quote",
    "forward_capacity_contract",
    "forward_capacity_offer",
    "forward_capacity_bid",
    "forward_capacity_trade",
    ...
    "futures_order_book_simulated",
    "futures_trade_simulated",
...
POSTGRES_COMPUTE_RECORD_TABLES: dict[str, str] = {
    "compute_provider": "compute_providers",
    "compute_route": "compute_routes",
    ...
    "intelligence_plan": "compute_intelligence_plans",
    "compute_price_snapshot": "compute_price_snapshots",
    "route_price_index": "compute_route_price_indexes",
    "provider_price_index": "compute_provider_price_indexes",
    "price_anomaly": "compute_price_anomalies",
    "price_forecast": "compute_price_forecasts",
    "intelligence_usage_record": "compute_intelligence_usage_records",
    "compute_statement": "compute_statements",
    "compute_intent": "compute_intents",
    "payment_intent": "compute_payment_intents",
    "payment_plan": "compute_payment_plans",
    "settlement_intent": "compute_settlement_intents",
    "task_economic_profile": "compute_task_economic_profiles",
    "agent_budget_policy": "compute_agent_budget_policies",
    "compute_market_policy": "compute_policies",
    "route_decision": "compute_decisions",
    "provider_capability": "compute_provider_capabilities",
    "unit_price_snapshot": "compute_unit_price_snapshots",
    "price_curve": "compute_price_curves",
    "economic_memory": "compute_economic_memory",
    ...
    "inference_credit_source": "inference_credit_sources",
    "inference_credit_account": "inference_credit_accounts",
    "inference_credit_balance": "inference_credit_balances",
    "inference_credit_listing": "inference_credit_listings",
    "inference_credit_order": "inference_credit_orders",
    "inference_credit_fill": "inference_credit_fills",
    "inference_credit_quote": "inference_credit_quotes",
    "inference_route": "inference_routes",
    "inference_market_decision": "inference_market_decisions",
    "opportunity_cost_decision": "inference_opportunity_cost_decisions",
    ...
    "capacity_window": "capacity_windows",
    "capacity_hold": "capacity_holds",
    "capacity_reservation": "capacity_reservations",
    "capacity_utilization_record": "capacity_utilization_records",
    "capacity_quote": "capacity_quotes",
    "capacity_forward_curve": "capacity_forward_curves",
    "forward_capacity_quote": "forward_capacity_quotes",
    "forward_capacity_contract": "forward_capacity_contracts",
    "forward_capacity_offer": "forward_capacity_offers",
    "forward_capacity_bid": "forward_capacity_bids",
    "forward_capacity_trade": "forward_capacity_trades",
    "forward_capacity_delivery_schedule": "forward_capacity_delivery_schedules",
    "forward_capacity_settlement_plan": "forward_capacity_settlement_plans",
    "forward_capacity_risk_assessment": "forward_capacity_risk_assessments",
    "delivery_obligation": "capacity_delivery_obligations",
    "delivery_receipt": "capacity_delivery_receipts",
    "futures_market": "futures_markets",
    "futures_contract_spec": "futures_contract_specs",
    "futures_order_simulated": "futures_orders_simulated",
    "futures_order_book_simulated": "futures_order_books_simulated",
    "futures_trade_simulated": "futures_trades_simulated",
    "futures_position_simulated": "futures_positions_simulated",
    "futures_mark_price": "futures_mark_prices",
    "futures_index_price": "futures_index_prices",
    "futures_margin_account_simulated": "futures_margin_accounts_simulated",
    "futures_risk_check": "futures_risk_checks",
    "futures_expiry": "futures_expiries",
    "futures_delivery_notice": "futures_delivery_notices",
    "futures_settlement_simulation": "futures_settlement_simulations",
    "compute_capacity_index": "compute_capacity_indexes",
    "gpu_capacity_spot_index": "gpu_capacity_spot_indexes",
    "gpu_forward_curve": "gpu_forward_curves",
    "implied_forward_price": "gpu_implied_forward_prices",
    "basis_risk_model": "gpu_basis_risk_models",
    "capacity_volatility_estimate": "capacity_volatility_estimates",
}

_POSTGRES_INDEXES_PER_RECORD_TYPE = 12
_POSTGRES_AUDIT_EVENT_EXTRA_INDEXES = 3
_POSTGRES_INDEX_COUNT = (
    len(COMPUTE_RECORD_TYPES) * _POSTGRES_INDEXES_PER_RECORD_TYPE + _POSTGRES_AUDIT_EVENT_EXTRA_INDEXES
)
...
def migration_plan() -> Mapping[str, Any]:
    return {
        ...
        "steps": (
            {
                "version": COMPUTE_MARKET_STORAGE_VERSION,
                "name": "compute_market_production_records_v7_marketplace_schema",
                ...
                "postgres_table_count": len(POSTGRES_COMPUTE_RECORD_TABLES),
                "postgres_index_count": _POSTGRES_INDEX_COUNT,
                "indexes": (
                    ...
                    "all PostgreSQL record tables by created_at, agent_id, goal_id, provider_id, route_id, task_type/task_hash, status, expires_at, request_id, actor_id, tenant/workspace, and idempotency",
                ...
                "description": (
                    "Create durable typed JSON record storage, marketplace provider onboarding, quote replay protection, "
                    "capacity reservations, dry-run job execution, no-custody billing ledgers, inference credit resale, "
                    "capacity and forward-capacity reservation markets, GPU futures simulation, agent treasury records, "
                    "capacity index records, intelligence-tier utility planning, compute price history, usage statements, "
                    "production query indexes, and tamper-evident audit chain columns for Flow Memory Compute Market."
                ),
                "reversible": False,
                "managed_sql_notes": (
