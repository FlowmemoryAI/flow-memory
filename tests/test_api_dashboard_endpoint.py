...
def test_dashboard_snapshot_loads_mock_data_without_raw_artifacts():
...
def test_dashboard_snapshot_router_endpoint():
...
def test_dashboard_read_scope_required_when_enabled():
