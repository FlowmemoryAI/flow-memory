...
def test_rl_benchmark_evidence_hashes_benchmark_files(tmp_path):
...
def test_release_evidence_documents_include_rl_benchmarks(tmp_path):
    docs = build_evidence_documents(tmp_path)
    assert "rl_benchmarks.json" in docs


def test_public_alpha_neural_release_target_declares_rl_benchmark_evidence(tmp_path):
